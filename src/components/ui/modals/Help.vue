    ...
    <div class="bg-surface-base text-text-primary rounded-2xl w-[80vw] h-[80vh] relative flex flex-col overflow-hidden shadow-2xl border border-border-subtle">
      ...
      <div class="flex-1 overflow-y-auto p-8 pt-24 space-y-8 text-left text-sm leading-relaxed">
        ...
        <section>
              ...
              <div class="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    required
                    autocomplete="name"
                    class="w-full px-3 py-2 border border-border-subtle rounded bg-surface-base text-text-primary focus:outline-none focus:ring-2 focus:ring-focus-ring focus:ring-offset-2 focus:ring-offset-surface-base text-sm"
                  />
                </div>
          ...
          <div v-else class="p-4 rounded bg-[rgba(var(--color-success-rgb),0.12)] text-status-success space-y-2">
