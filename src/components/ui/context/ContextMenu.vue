  ...
  >
    <ul class="space-y-1">
      <li
        ...
        :key="f.label"
        class="px-2 py-1 rounded cursor-pointer hover:bg-[color-mix(in_srgb,var(--color-bg-surface)_85%,transparent)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-focus"
        tabindex="0"
        role="menuitem"
