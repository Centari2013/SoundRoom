      ...
      <transition name="fade">
        ...
        >
          <template v-for="button in visibleButtons" :key="button.label">
            <button
              class="w-full px-4 py-2 text-left text-sm text-text-primary hover:bg-[color-mix(in_srgb,var(--color-bg-surface)_85%,transparent)] focus:outline-none !bg-transparent"
              type="button"
