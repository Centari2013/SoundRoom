  ...
  <div class="relative flex items-center justify-between h-15 p-2">
    <div class="flex space-x-3">
      <BaseButton
        ...
        class="px-3 py-2 rounded bg-[var(--sr-bg-1)] hover:bg-[var(--sr-bg-0)] text-[var(--sr-text-0)] border border-[var(--sr-panel-border)] dark:bg-[var(--sr-bg-2)] dark:hover:bg-[var(--sr-bg-1)] transition focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
        type="button"
