  ...
  <div class="relative flex items-center justify-between h-15 p-2">
    <div class="flex space-x-3">
      <BaseButton
        ...
        class="px-3 py-2 rounded bg-surface-base hover:bg-surface-raised text-text-primary border border-border-subtle transition focus:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring"
        type="button"
