<template>
  <section class="text-[var(--sr-text-0)]">
    <h5 class="text-sm font-semibold uppercase text-[var(--sr-text-1)] dark:text-[var(--sr-text-1)] mb-2">
      Selected Source
    </h5>
    ...
    <div v-if="selectedSource" class="space-y-6 flex flex-col items-center">
      ...
      <div class="w-full space-y-2">
        <button
          ...
          class="w-full bg-[var(--sr-bg-1)] dark:bg-red-600 text-xs rounded hover:bg-[var(--sr-bg-0)] dark:hover:bg-red-500 border border-[var(--sr-panel-border)] dark:border-red-700 text-[var(--sr-text-0)] dark:text-[var(--sr-text-0)]"
        >
          {{ playPauseLabel }}
        </button>
        <button
      ...
      <hr class="w-full border-[var(--sr-panel-border)] dark:border-[var(--sr-panel-border)]" />
      ...
      <div
        ...
        class="space-y-4 w-full text-xs text-[var(--sr-text-1)] dark:text-[var(--sr-text-1)] px-1"
      >
        <!-- Mode -->
        <div class="flex flex-col space-y-1">
          ...
          <select
            ...
            class="px-2 py-1 rounded border border-[var(--sr-panel-border)] dark:bg-[var(--sr-bg-2)] dark:border-[var(--sr-panel-border)]">
