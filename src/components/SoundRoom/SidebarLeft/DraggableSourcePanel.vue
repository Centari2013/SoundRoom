<template>
  ...
  <h5 class="text-sm font-semibold uppercase text-[var(--sr-text-1)] dark:text-[var(--sr-text-1)]">
    Sound Sources
  </h5>
  ...
  <button
    ...
    class="w-full mt-4 bg-[var(--sr-bg-1)] dark:bg-[var(--sr-bg-2)] text-xs rounded hover:bg-[var(--sr-bg-0)] dark:hover:bg-[var(--sr-bg-1)] border border-[var(--sr-panel-border)] dark:border-[var(--sr-panel-border)] text-[var(--sr-text-0)]"
  >
    + Add Source
  </button>
</section>
