        ...
        <div class="space-y-6">
          <div class="flex items-start justify-between gap-6">
            ...
            <label class="relative inline-flex items-center cursor-pointer select-none">
              ...
              <span class="block w-12 h-6 rounded-full bg-border-subtle transition-colors peer-focus:outline peer-focus:outline-2 peer-focus:outline-focus-ring peer-checked:bg-accent-strong"></span>
