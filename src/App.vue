...
<template>
  ...
  <div class="h-screen max-h-screen min-w-screen flex flex-col">
    ...
    <div class="flex-1 min-h-0 flex flex-col">
      <div
        v-if="globalError"
        class="flex-1 flex flex-col items-center justify-center text-center px-6 py-12 bg-[var(--sr-bg-0)] text-[var(--sr-text-0)] dark:bg-[var(--sr-bg-0)] dark:text-[var(--sr-text-0)]"
      >
        ...
        <p class="max-w-md text-[var(--sr-text-1)] dark:text-[var(--sr-text-1)] mb-8">
          {{ globalError.message }}
        </p>
      ...
      <RouterView v-else v-slot="{ Component, route }">
        <Suspense>
          ...
          <template #fallback>
            <div class="flex-1 flex flex-col items-center justify-center text-center px-6 py-12 bg-[var(--sr-bg-0)] text-[var(--sr-text-0)] dark:bg-[var(--sr-bg-0)] dark:text-[var(--sr-text-0)]">
              ...
              <p class="max-w-md text-[var(--sr-text-1)] dark:text-[var(--sr-text-1)]">
